...
IBKR_VM_READINESS_COMMAND = (
    ...
    "--key /Users/tani/Downloads/ssh-key-2026-03-04-4.key --print-json"
)
...
def build_vm_ibkr_readiness_status(out_dir: Path, day8: str) -> Dict[str, Any]:
    ...
    if ok:
        ...
        next_action = "python3 tools/vm_ibkr_gateway_readiness.py --host 161.33.26.35 --key /Users/tani/Downloads/ssh-key-2026-03-04-4.key を実行"
    elif stale:
    ...
    if needs_smoke:
        if latest_error and latest_error.get("diagnosis") and not suppress_local_only_error:
            ...
            if not effective_runtime_status["running"]:
                ...
                next_action = "VM IB GatewayはOK。Mac側で ./tools/open_vm_ibkr_tunnel.sh --host 161.33.26.35 --key /Users/tani/Downloads/ssh-key-2026-03-04-4.key を開く"
