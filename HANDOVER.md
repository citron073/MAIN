...
- 追加確認コマンド: `python3 tools/vm_ibkr_gateway_readiness.py --host 161.33.26.35 --key /Users/tani/.ssh/ouroboros_vm_key --timeout-sec 8 --print-json`、`python3 test_ibkr_connection.py --host 127.0.0.1 --port 17497 --client-id 11 --stocks AAPL,MSFT,NVDA,TSLA,QQQ,SPY --fx USDJPY`。
